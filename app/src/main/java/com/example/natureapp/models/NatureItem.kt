...
data class NatureItem (
    ...
    companion object{
        val natureItems = mutableListOf(
            ...
            NatureItem("Islas Galápagos","Las islas Galápagos son un archipiélago volcánico del océano Pacífico. Conocido como uno de los destinos más famosos del mundo para la observación de fauna. Es una provincia de Ecuador. Su terreno aislado alberga una diversidad de especies animales y vegetales, muchas de ellas exclusivas.", "https://www.cronista.com/files/image/464/464741/62a0d322a742c_934_616!.webp?s=02062551882de246c8a080f4cb5f8251&d=1654706987&oe=jpg"),
        )
    }
}